window.onload = function () {
    ...
    function updateCartPopup() {
      ...
      content += `
        ...
        <div style="text-align: center; margin-top: 10px;">
          <button style="padding: 8px 15px; background-color: #f58c8c; color: white; border: none; border-radius: 6px; cursor: pointer;">Checkout</button>
        </div>
        </div>`;
    ...
    addToCartButtons.forEach(button => {
      button.addEventListener("click", () => {
        ...
        saveCart();
        updateCartPopup();
        showAddedPopup(); // 🎉 Show popup here
      });
    });
